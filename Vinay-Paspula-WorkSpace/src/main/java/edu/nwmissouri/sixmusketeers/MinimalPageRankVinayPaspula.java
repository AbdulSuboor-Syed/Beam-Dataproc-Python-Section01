 ...
 * file service.
 */
public class MinimalPageRankVinayPaspula {
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String,String>> pcolKVO = VinayPaspulaKVS(p,dataFolder ,"go.md");
    PCollection<KV<String,String>> pcolKVO1 = VinayPaspulaKVS(p,dataFolder, "java.md");
    PCollection<KV<String,String>> pcolKVO2 = VinayPaspulaKVS(p,dataFolder, "python.md");
    PCollection<KV<String,String>> pcolKVO3 = VinayPaspulaKVS(p,dataFolder, "README.md");
      ...
      PCollection<KV<String,Iterable<String>>> listReducedPairs = mergedList.apply(GroupByKey.<String,String>create());

PCollection<String> output = listReducedPairs.apply(MapElements.into(TypeDescriptors.strings()).via(kv -> kv.toString()));

output.apply(TextIO.write().to("VinayPaspula-Job01"));
    

    p.run().waitUntilFinish();
  }

  private static PCollection<KV<String,String>> VinayPaspulaKVS(Pipeline p, String dataFolder, String dataFile) {
